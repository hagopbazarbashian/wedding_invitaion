...
@section('admin_home')
@section('title'){{'Activ Card'}}@endsection
             ...
             <div class="card-body">
                <div class="table-responsive rounded py-4 table-space">
                   <table id="user-list-table" class="table custom-table" role="grid" data-toggle="data-table">
                      ...
                      <tbody>
                        @foreach ($cardforms as $key=>$cardform)
                        <tr>
                            <td>{{$cardform->user->name}}</td>
                            <td>15{{$cardform->user->id}}</td>
                            <td> <button type="button" class="btn btn-success">Card Is Activ Now</button></td>
                            {{-- <td>
